        ...
        <div class="card-elegant rounded-xl p-6">
            <div class="space-y-6">
                ...
                <div class="flex flex-col sm:flex-row gap-3 pt-6 border-t border-slate-200 dark:border-slate-700">
                    <a href="{{ route('admin.leaderboards.edit', $leaderboard) }}" class="flex items-center justify-center gap-2 px-6 py-3 rounded-lg bg-gradient-to-r from-emerald-500 to-teal-500 hover:from-emerald-600 hover:to-teal-600 text-white font-medium @permClass('leaderboards.edit')" @permDisabled('leaderboards.edit')>
