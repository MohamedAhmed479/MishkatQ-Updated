    ...
    <div class="space-y-6">
        ...
        <div class="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
            ...
            <a href="{{ route('admin.badges.create') }}" 
               class="flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-amber-500 to-orange-500 hover:from-amber-600 hover:to-orange-600 text-white font-medium rounded-lg shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-200 @permClass('badges.create')" @permDisabled('badges.create')>
                            ...
                            <div class="bg-white dark:bg-slate-800 rounded-xl p-6 border border-slate-200 dark:border-slate-700 hover:shadow-lg transition-all duration-300 hover:border-amber-300 dark:hover:border-amber-600">
                                ...
                                <div class="flex items-center justify-center gap-2">
                                     <a href="{{ route('admin.badges.show', $badge) }}" 
                                        class="p-2 rounded-lg text-blue-600 hover:bg-blue-50 dark:hover:bg-blue-900/20 transition-colors @permClass('badges.view')" @permDisabled('badges.view')
                                       title="عرض التفاصيل">
                                     ...
                                     <a href="{{ route('admin.badges.edit', $badge) }}" 
                                        class="p-2 rounded-lg text-amber-600 hover:bg-amber-50 dark:hover:bg-amber-900/20 transition-colors @permClass('badges.edit')" @permDisabled('badges.edit')
                                       title="تعديل">
                                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    ...
                                    <!-- Toggle Status -->
                                     <form method="POST" action="{{ route('admin.badges.toggle-status', $badge) }}" class="inline @permClass('badges.toggle-status')">
                                        @csrf
                                        @method('PATCH')
                                         <button type="submit" @permDisabled('badges.toggle-status')
                                    ...
                                    <!-- Delete -->
                                     <form method="POST" action="{{ route('admin.badges.destroy', $badge) }}" class="inline @permClass('badges.delete')" 
                                          onsubmit="return confirm('هل تريد حذف هذه الشارة نهائياً؟\n\nتحذير: هذا الإجراء لا يمكن التراجع عنه!')">
                                        @csrf
                                        @method('DELETE')
                                         <button type="submit" @permDisabled('badges.delete')
