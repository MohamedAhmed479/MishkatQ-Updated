...
<div class="p-6">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6">
        <div>
            <h1 class="text-xl sm:text-2xl font-bold text-slate-900 dark:text-slate-100">تعديل السورة</h1>
            <p class="text-sm sm:text-base text-slate-600 dark:text-slate-400">تعديل بيانات السورة: {{ $chapter->name_ar }}</p>
        </div>
        <div class="flex flex-col sm:flex-row items-stretch sm:items-center gap-3">
            <a href="{{ route('admin.chapters.show', $chapter) }}" 
               class="inline-flex items-center justify-center gap-2 px-4 py-2.5 bg-blue-600 hover:bg-blue-700 text-white font-medium rounded-lg transition-colors duration-200 touch-manipulation">
    ...
    <div class="max-w-2xl">
            ...
            <div class="p-4 sm:p-6">
                <form action="{{ route('admin.chapters.update', $chapter) }}" method="POST">
                    ...
                    <div class="flex flex-col sm:flex-row items-stretch sm:items-center gap-3 sm:gap-4 pt-4 sm:pt-6 border-t border-slate-200 dark:border-slate-700">
                        <button type="submit" @permDisabled('chapters.edit')
                                class="flex-1 sm:flex-none px-6 py-2.5 bg-emerald-600 hover:bg-emerald-700 text-white font-medium rounded-lg transition-colors duration-200 touch-manipulation @permClass('chapters.edit')">
        ...
        <div class="mt-6 bg-slate-50 dark:bg-slate-700/50 border border-slate-200 dark:border-slate-700 rounded-xl p-4 sm:p-6">
            <h3 class="text-lg font-semibold text-slate-900 dark:text-slate-100 mb-4">معلومات السورة الحالية</h3>
