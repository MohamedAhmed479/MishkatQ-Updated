...
<div class="p-6">
    ...
    <div class="flex items-center justify-between mb-6">
        <div>
            <h1 class="text-2xl font-bold text-slate-900 dark:text-slate-100">إضافة سورة جديدة</h1>
            <p class="text-slate-600 dark:text-slate-400">إضافة سورة جديدة إلى القرآن الكريم</p>
        </div>
    ...
    <div class="max-w-2xl">
        ...
        <div class="mt-6 bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-xl p-6">
            <div class="flex items-start gap-3">
                ...
                <div>
                    <h3 class="font-medium text-blue-900 dark:text-blue-100 mb-2">معلومات مهمة</h3>
