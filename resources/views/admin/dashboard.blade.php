    ...
    <div class="relative overflow-hidden rounded-3xl bg-gradient-to-br from-indigo-600 via-purple-600 to-pink-600 p-6 lg:p-8 text-white shadow-2xl">
        ...
        <div class="relative z-10">
            ...
            <div class="flex flex-col sm:flex-row gap-3 items-center justify-center">
                ...
                <a href="{{ route('admin.dashboard.export-reviews') }}?range={{ $filters['range'] ?? 'last_30_days' }}" class="w-full sm:w-auto inline-flex items-center justify-center gap-2 rounded-xl bg-white/20 backdrop-blur-sm px-4 lg:px-6 py-2 lg:py-3 text-sm text-white hover:bg-white/30 transition-all duration-300 @permClass('dashboard.export')" @permDisabled('dashboard.export')>
                    <svg class="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
